---
name: ui-ux-pro-max
description: Generate and implement UI/UX design systems using a searchable local database of 67 styles, 96 color palettes, 57 font pairings, 99 UX guidelines, 25 chart types, and 13 technology stacks. Use for designing, building, restyling, or improving web and mobile interfaces, landing pages, dashboards, design systems, colors, typography, charts, and accessibility.
---
# ui-ux-pro-max

Comprehensive design guide for web and mobile applications with a searchable database and priority-based recommendations.

## Resolve the skill path

Before running a bundled script, resolve the absolute directory containing this `SKILL.md` and call its `scripts/search.py`. In the commands below, replace `<skill-dir>` with that absolute directory. Do not assume the repository is inside the user's current project.

- macOS/Linux: use `python3 "<skill-dir>/scripts/search.py"`.
- Windows: use `python "<skill-dir>\scripts\search.py"`.
